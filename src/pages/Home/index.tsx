...
export default function Home() {
    return <div className="home container is-fluid pt-5">
        <h1>Hello to Keep alive your typescript definitions using Zod!</h1>
        ...
        <h4>
            The repository is hosted on<br /><a href="https://github.com/Puppo/keep-alive-your-typescript-definitions-using-zod" target="_blank" rel="noreferrer">https://github.com/Puppo/keep-alive-your-typescript-definitions-using-zod</a>.
        </h4>
        <h4>
